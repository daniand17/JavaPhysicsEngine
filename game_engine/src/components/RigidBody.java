...
public class RigidBody {
	...
	public Vector2 position; // The position of this RigidBody
	...
	public Vector2 force; // Force acting on the RigidBody for the next physics update
	 ...
	 * velocity and mass.
	 * 
	 * @param Vector2 initVelocity 
	 * 			The initial velocity of the rigidbody
	 * 
	 * @param initMass
	 * 			The initial mass of the rigidbody
	 */
	public RigidBody(Vector2 position, Vector2 velocity, double mass, double zeta){
	...
	/**
	 * Method to SET a force on the object, wiping out any other forces currently active.
	 * @param direction
	 * 			Direction of the force. Should be a unit vector, but will be divided by its magnitude
	 * 	
	 * @param amount
	...
	/**
	 * Method to ADD a force to an object, in addition to any other forces currently present.
	 * @param direction
	 * 			Direction of the force. Should be a unit vector, but will be divided by its magnitude
	 * 	
	 * @param amount
